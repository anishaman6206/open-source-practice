...
1. **Find a project** you care about or want to learn from
2. **Read the contributing guide** — every project has its own rules
3. **Fork the repo** — make your own copy
4. **Pick an issue** — look for labels like `good first issue` or `help wanted`
5. **Make your change** on a new branch
6. **Open a Pull Request** — ask the maintainers to review your work
7. **Address feedback** — iterate until it's ready
8. **Get merged** — your code is now part of the project! 🎉
