...
👉 Read the full step-by-step guide in [CONTRIBUTING.md](CONTRIBUTING.md) before you start.
...
**Task:** Add your name to the [Contributors Hall of Fame](#contributors-hall-of-fame) section below.
...
**Task:** Fix an intentional typo in [`docs/about.md`](docs/about.md).
...
**Task:** Add one fun fact about yourself or anything interesting to [`docs/fun-facts.md`](docs/fun-facts.md).
...
- 💬 Open a [Question Issue](.github/ISSUE_TEMPLATE/question.md) — there are no silly questions
- 🔍 Check [docs/common-errors.md](docs/common-errors.md) for common Git mistakes and how to fix them
